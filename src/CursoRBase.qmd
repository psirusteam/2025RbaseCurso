...
| **Tipo de archivo** | **Librería** | **Función para importar** | **Ejemplo en R** |
|-------------------|-------------------|-------------------|----------------------------------|
| CSV | readr | `read_csv()` | `datos <- read_csv("data/archivo.csv")` |
| Texto delimitado “;” | readr | `read_delim()` | `datos <- read_delim("data/archivo.txt", delim = ";")` |
| Texto delimitado tab | readr | `read_tsv()` | `datos <- read_tsv("data/archivo.tsv")` |
| Excel (.xlsx) | readxl | `read_excel()` | `datos <- read_excel("data/datos.xlsx")` |
| RDS (.rds) | Base de R | `readRDS()` | `datos <- readRDS("data/base.rds")` |
| RData (.RData) | Base de R | `load()` | `load("data/mi_objeto.RData")` |
...
| **Tipo de archivo** | **Librería** | **Función para importar** | **Ejemplo en R** |
|-------------------|-------------------|-------------------|----------------------------------|
| SPSS (.sav) | haven | `read_sav()` | `datos <- read_sav("data/archivo.sav")` |
| Stata (.dta) | haven | `read_dta()` | `datos <- read_dta("data/archivo.dta")` |
| JSON | jsonlite | `fromJSON()` | `datos <- fromJSON("data/archivo.json")` |
| CSV grande (.csv.gz) | data.table | `fread()` | `datos <- fread("data/archivo.csv.gz")` |
