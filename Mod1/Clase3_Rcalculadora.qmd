...
| ------------------------- | ------------------------------------------------ | --------------------------------------------- |
| R como lenguaje numérico  | R permite cálculos simples y complejos           | Uso de R como calculadora científica          |
| Operaciones básicas       | Suma, resta, multiplicación, división, potencias | Ejecución correcta de expresiones matemáticas |
| Orden de operaciones      | Paréntesis → Potencias → * / → + -               | Interpretación correcta de resultados         |
| Funciones matemáticas     | `sqrt()`, `abs()`, `round()`, `log()`, `exp()`   | Aplicación de funciones integradas            |
| Funciones trigonométricas | `sin()`, `cos()`, `tan()` (en radianes)          | Cálculo de funciones angulares                |
| Asignación de valores     | Operador `<-` para crear objetos                 | Almacenamiento y reutilización de resultados  |
