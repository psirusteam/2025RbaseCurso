...
| ------------------------- | -------------------------------------------------------------- | -------------------------------------------------- |
| Descripción de datos      | Exploración inicial antes del análisis                         | Comprensión general de la información              |
| Tipos de datos en R       | `numeric`, `integer`, `character`, `logical`, `factor`, `Date` | Identificación correcta del tipo de variable       |
| Estructura de datos       | Uso de `str()`                                                 | Reconocimiento de clases y formatos                |
| Resumen estadístico       | `summary()`                                                    | Visión global de variables numéricas y categóricas |
| Estadísticos descriptivos | Media, mediana, varianza, desviación estándar, rango           | Medición de tendencia central y dispersión         |
| Tablas de frecuencia      | `table()`, `prop.table()`                                      | Análisis de variables cualitativas                 |
| Visualización básica      | Histogramas y boxplots                                         | Detección de patrones y valores atípicos           |
