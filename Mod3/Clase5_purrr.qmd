---
title: "Fundamentos de ciencia de datos con R - Módulo 3"
subtitle: "Clase 5: Uso de las funciones más comunes del paquete `purrr`"
...
| **Concepto**   | **Idea clave**                          |
| -------------- | --------------------------------------- |
| `purrr`        | Programación funcional en R             |
| `map()`        | Reemplaza bucles para aplicar funciones |
| `map_*()`      | Salidas con tipo predecible             |
| Integración    | Funciona con `mutate()` y `%>%`         |
