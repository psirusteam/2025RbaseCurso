...
subtitle: "Clase 1: Joins (Left y Right)"
...
| **Concepto**   | **Idea clave**                                         |
| -------------- | ------------------------------------------------------ |
| `left_join()`  | Conserva el universo principal (por ejemplo, personas) |
| `right_join()` | Prioriza el marco maestro (por ejemplo, hogares)       |
