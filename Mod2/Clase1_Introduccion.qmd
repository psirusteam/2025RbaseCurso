---
title: "Fundamentos de ciencia de datos con R - Módulo 2"
subtitle: "Clase 1: Introducción al Tidyverse"
...
| ------------------------ | --------------------------------------------------------- | ---------------------------------------------------- |
| Tidyverse                | Ecosistema de paquetes con sintaxis coherente             | Flujo de trabajo integrado para análisis de datos    |
| Filosofía *tidy data*    | Variables en columnas, observaciones en filas             | Datos ordenados y fáciles de analizar                |
| Paquetes principales     | `dplyr`, `ggplot2`, `readr`, `tidyr`                      | Manipulación, visualización e importación eficientes |
| Ecosistema ampliado      | `purrr`, `stringr`, `forcats`, `lubridate`, `broom`, etc. | Cobertura completa del ciclo de análisis             |
| `data.frame` vs `tibble` | Tibble como versión moderna y segura                      | Manejo más predecible de tablas                      |
| Operador pipe `%>%`      | Encadenamiento de funciones                               | Código más legible y expresivo                       |
| Exploración de datos     | `glimpse()`                                               | Comprensión rápida de la estructura                  |
