...
subtitle: "Clase 4: ifelse() y case_when()"
...
| **Concepto**             | **Idea clave**                            |
| ------------------------ | ----------------------------------------- |
| Programación condicional | Crear variables según condiciones lógicas |
| `if_else()`              | Dos resultados posibles                   |
| `case_when()`            | Múltiples condiciones                     |
| Integración tidyverse    | Uso con `mutate()` y `%>%`                |
